...
<link rel="stylesheet" href="css/HOME/Feedback_css/feedback.css"/>
            ...
            <div class="testimonial-box">
                ...
                <div class="box-top">
                    ...
                    <div class="profile">
                        ...
                        <!--name-and-username-->
                        <div class="name-user">
                            <strong>Alok Kar</strong>
                            <span>alokkar1996@gmail.com</span>
                        </div>
                    </div>
                    <!--reviews------>
                    <div class="reviews">
            ...
            <div class="testimonial-box">
                ...
                <div class="box-top">
                    ...
                    <div class="profile">
                        ...
                        <!--name-and-username-->
                        <div class="name-user">
                            <strong>Divya Kumari</strong>
                            <span>divya62050@gmail.com</span>
                        </div>
                    </div>
                    <!--reviews------>
                    <div class="reviews">
            ...
            <div class="testimonial-box">
                ...
                <div class="box-top">
                    ...
                    <div class="profile">
                        ...
                        <!--name-and-username-->
                        <div class="name-user">
                            <strong>Seemarekha Behera</strong>
                            <span>bseemarekha13@gmail.com</span>
                        </div>
                    </div>
                    <!--reviews------>
                    <div class="reviews">
            ...
            <div class="testimonial-box">
                ...
                <div class="box-top">
                    ...
                    <div class="profile">
                        ...
                        <!--name-and-username-->
                        <div class="name-user">
                            <strong>Subhashree Parida</strong>
                            <span>subhashree@gmail.com</span>
                        </div>
                    </div>
                    <!--reviews------>
                    <div class="reviews">
